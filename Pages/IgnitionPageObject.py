...
class IgnitionPageObject(BasicPageObject):
    ...
    def __init__(
        ...
        :param timeout: The amount of time (in seconds) this page resource should implicitly wait when needed.
        ...
        BasicPageObject.__init__(
            self, driver=driver, url=self.url, timeout=timeout, primary_locator=primary_locator)
